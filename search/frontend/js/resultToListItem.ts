...
export function resultToListItem(
  ...
  template.innerHTML = `
<li class="search-result${options.selected ? " selected" : ""}">
  <a href="${result.entry.url}">
    <div style="display: flex; justify-content: space-between">
      <p class="search-title">${highlight(
        result.entry.title,
      ...
      ${result.excerpts
        .map(
          e => `<div style="display: flex; justify-content: space-between"><p class="search-excerpt">
